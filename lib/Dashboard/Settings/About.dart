...
import 'package:women_safety_fyp/Dashboard/Settings/AboutCard.dart';
      ...
      body: ListView(
        children: [
          AboutCard(
            asset: "logo",
            desc:
                """Women Safty is a vigilant mobile application that enables the user to stay connected with the ones who care! It gives the user an option to share live location to concerned people through SOS alerts and enables the user to access emergency services. Be a witness of the unfortunate occurring incident and call for help. It is your personal companion.""",
          ...
          Row(
            children: [
              ...
              Text("© 2022 GDSC CUI, All rights reserved."),
              Expanded(
                child: Divider(
                  indent: 10,
                  endIndent: 10,
